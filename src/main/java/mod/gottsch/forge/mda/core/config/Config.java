...
public class Config extends AbstractConfig {
	...
	public static class DistanceScalingConfig {
		...
		public ModConfigSpec.IntValue blocksPerTier;
		public ModConfigSpec.DoubleValue multiplierPerTier;
		public ModConfigSpec.DoubleValue cap;

		public DistanceScalingConfig(ModConfigSpec.Builder builder) {
	...
	public static abstract class AttribConfig {
		public ModConfigSpec.BooleanValue enable;
		public ModConfigSpec.BooleanValue autoDice;
		...
		public void configure(ModConfigSpec.Builder builder) {
			...
			diceType = builder
					.comment(" The type of dice to use for calculations when autoDice is false.",
	...
	public static class ArmorConfig extends AttribConfig {
		...
		public void configure(ModConfigSpec.Builder builder) {
			...
			bonus = builder
					.comment("bonus")
					.defineInRange("bonus", 0, 0, ((RangedAttribute) Attributes.ARMOR.value()).getMaxValue());
		}
	}

	public static class ArmorToughnessConfig extends AttribConfig {
		public ArmorToughnessConfig(ModConfigSpec.Builder builder) {
		...
		public void configure(ModConfigSpec.Builder builder) {
			...
			bonus = builder
					.comment("bonus")
					.defineInRange("bonus", 0, 0, ((RangedAttribute) Attributes.ARMOR_TOUGHNESS.value()).getMaxValue());
		}
	}

	public static class AttackSpeedConfig extends AttribConfig {
		public AttackSpeedConfig(ModConfigSpec.Builder builder) {
		...
		public void configure(ModConfigSpec.Builder builder) {
			...
			bonus = builder
					.comment("bonus")
					.defineInRange("bonus", 0, 0, ((RangedAttribute) Attributes.ATTACK_SPEED.value()).getMaxValue());
		}
	}

	public static class FollowRangeConfig extends AttribConfig {
		public FollowRangeConfig(ModConfigSpec.Builder builder) {
		...
		public void configure(ModConfigSpec.Builder builder) {
			...
			bonus = builder
					.comment("bonus")
					.defineInRange("bonus", 0, 0, ((RangedAttribute) Attributes.FOLLOW_RANGE.value()).getMaxValue());
		}
	}

	public static class EliteMobsConfig {
		public ModConfigSpec.BooleanValue enable;
		public ModConfigSpec.DoubleValue healthThreshold;
		public ConfigValue<String> namePrefix;
		public ModConfigSpec.BooleanValue showName;

		public EliteMobsConfig(ModConfigSpec.Builder builder) {
	...
	public static class LootScalingConfig {
		public ModConfigSpec.BooleanValue enable;
		public ModConfigSpec.DoubleValue threshold;
		public ModConfigSpec.DoubleValue xpMultiplier;
		public ModConfigSpec.IntValue lootBonusRolls;

		public LootScalingConfig(ModConfigSpec.Builder builder) {
	...
	public static class RarityTiersConfig {
		...
		public RarityTiersConfig(ModConfigSpec.Builder builder) {
	...
	public static class SpawnHooksConfig {
		...
		public SpawnHooksConfig(ModConfigSpec.Builder builder) {
